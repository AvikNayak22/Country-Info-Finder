...
export default function Article({
  ...
  return (
    <>
      <Link to={`/${name.common}`}>
        <article className="bg-[#F1F1F1] shadow-md hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 transition-all duration-200 rounded-lg shadow overflow-hidden">
